...
<body>
  <form name="deleteForm" method="post" action="${ctxpath}/faq/deletePro.do" onSubmit="return check()">
   ...
   <h2>글삭제 폼</h2>
    <div class="inputForm">
     ...
     <tr>
       ...
       <input type="button" value="글목록" onClick="location='${ctxpath}/faq/list.do?pageNum=${pageNum}'">
       </td>
     </tr>
